...
/**
 * Demo application showing the agent serve with SSE transport.
 *
 * <p>
 * Identical agent configuration as the WebSocket chatbot demo, but served over
 * Server-Sent Events instead. The browser uses the native {@code EventSource} API
 * for receiving events and {@code fetch()} for sending messages.
 *
 * <p>
