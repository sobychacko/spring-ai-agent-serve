 ...
 *
 * <p>
 * This class is called from the SSE reader thread. It prints streaming text, tool
...
class ConsoleEventRenderer {
	...
	/**
	 * Holds question data passed from the SSE reader thread to the main stdin thread.
	 */
