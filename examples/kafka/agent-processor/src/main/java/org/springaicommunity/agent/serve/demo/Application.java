...
/**
 * Kafka-backed agent processor.
 *
 * <p>
 * This application consumes {@code AgentRequest} messages from a Kafka topic, processes
 * them through a Spring AI agent, and produces {@code AgentEvent} messages back to
 * another topic. No web server is started — this is a pure consumer/producer backend
 * service.
 *
 * <p>
 * The Kafka starter auto-configures the listeners, event sender, and session management.
