...
/**
 * Tests for {@link AmqpAgentListener}.
 */
@DisplayName("AmqpAgentListener Tests")
@ExtendWith(MockitoExtension.class)
class AmqpAgentListenerTest {
	...
	private AmqpAgentListener listener;

	@BeforeEach
	void setUp() {
		this.listener = new AmqpAgentListener(this.sessionManager, this.eventSender);
	}
